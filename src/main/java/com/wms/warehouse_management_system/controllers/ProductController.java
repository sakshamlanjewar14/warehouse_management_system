...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse<List<Product>>> getAllProduct(){
        ...
        if(products.isEmpty()){
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(ApiResponse.error("Products Not Found"));
        }
    ...
    public ResponseEntity<ApiResponse<Product>> getProductById(@PathVariable("productId") Long productId){
        ...
        if(product == null){
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(ApiResponse.error("Product Not Found For Id :"+ productId));
        }
